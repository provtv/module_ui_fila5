---
title: "On-Demand Pattern — Module UI"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
| Ricerca locale | `qmd search "topic" -c ui` |
| Wiki locale | `Read ./laravel/Modules/UI/docs/wiki/index.md` |
